...
header.header.container-fluid
  .row.align-items-center.justify-content-between
    .col.col-sm-auto.d-flex.align-items-center.justify-content-between.justify-content-sm-start
      ...
      img.header__logo.me-4.me-sm-5(src="@/assets/template/logo_udes.svg")

      .d-none.d-md-flex.align-items-center(v-if="isInicio")
        a(href="#contenidos").me-5 Contenidosxxxx
...
<script>
import plantillaMixins from '../components/plantillaMixins'
export default {
  name: 'Header',
