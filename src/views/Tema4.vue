  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .contenedor-imagen-up.p-3.mb-5
      .row.mb-5.g-5.align-items-center.justify-content-end
        ...
        .col-xl-8
          h2.fw-normal.w-75 Los datos personales es la información de un individuo
    ...
    .row.mb-5.align-items-center.justify-content-center
      .col-lg-2.col-md-3.col-8: img(src='@/assets/curso/62.svg').mb-4.mb-lg-0
    ...
    SlyderA.slyder-rojo-2.mb-5
      .row.justify-content-center
        .col-lg-4.col-8
          figure
            img(src='@/assets/curso/66.png', alt='Texto que describa la imagen').mb-3
