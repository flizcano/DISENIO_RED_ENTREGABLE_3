...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.align-items-center.justify-content-center
      .col-lg-2.col-md-3.col-sm-4: img(src='@/assets/curso/62.svg').mb-3.mb-lg-0
      .col-lg-10.col-md-9.col-sm-8
        p.fw-bold También encontramos dentro de la normatividad de seguridad de la información:
    ...
    SlyderA.slyder-rojo-2.mb-5
      .row
        ...
        .col-md-8.mb-4.mb-md-0
          ...
          p a. El titular entrega autorización explícita en el tratamiento de los datos.          
            br
